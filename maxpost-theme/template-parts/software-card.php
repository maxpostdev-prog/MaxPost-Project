...
<article class="software-card software-card--<?php echo esc_attr( $category_key ); ?>">
	<a class="software-card__media" href="<?php the_permalink(); ?>" aria-label="<?php echo esc_attr( sprintf( __( 'View %s', 'maxpost' ), $software['name'] ) ); ?>">
		...
		<?php else : ?>
			<span class="software-card__visual" aria-hidden="true">
		...
		<?php endif; ?>
		<span class="software-card__status"><?php esc_html_e( 'Windows utility', 'maxpost' ); ?></span>
	</a>
	<div class="software-card__body">
		<div class="software-card__topline">
			<p class="software-card__eyebrow"><?php echo esc_html( $category ); ?></p>
			<?php if ( $software['version'] ) : ?>
				<span class="software-card__version">v<?php echo esc_html( $software['version'] ); ?></span>
			<?php endif; ?>
		</div>
		...
		<div class="software-card__meta">
			<span><?php esc_html_e( 'Free', 'maxpost' ); ?></span>
			<?php if ( $software['file_size'] ) : ?><span><?php echo esc_html( $software['file_size'] ); ?></span><?php endif; ?>
			<span><?php esc_html_e( 'Windows 10/11', 'maxpost' ); ?></span>
		</div>
		<div class="software-card__actions">
			<?php if ( $software['download_url'] ) : ?>
				<a class="mp-button mp-button--primary mp-button--compact" href="<?php echo esc_url( $software['download_url'] ); ?>"><?php esc_html_e( 'Download', 'maxpost' ); ?></a>
			<?php endif; ?>
			<a class="mp-button mp-button--ghost mp-button--compact" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Details', 'maxpost' ); ?> <span aria-hidden="true">→</span></a>
		</div>
	</div>
</article>
