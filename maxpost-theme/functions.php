...
function maxpost_theme_assets(): void {
	wp_enqueue_style( 'maxpost-style', get_stylesheet_uri(), [], wp_get_theme()->get( 'Version' ) );
	wp_enqueue_style( 'maxpost-main', get_template_directory_uri() . '/assets/css/main.css', [ 'maxpost-style' ], wp_get_theme()->get( 'Version' ) );
}
